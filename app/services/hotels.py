...
def handle_hotels(chat_id: int, user_id: int, text: str):
    ...
    # если знаем страну → нормальный deeplink
    if country_slug:
        url = f"https://hotels.travelata.ru/{country_slug}?marker={TRAVELPAYOUTS_MARKER}"
        text_result = (
        ...
        url = f"https://hotels.travelata.ru/search?query={query}&marker={TRAVELPAYOUTS_MARKER}"
        text_result = (
            "✨ Ваше желание исполнено, мой господин.\n"
            f"🏨 {city_title}\n"
            "Открою поиск отелей.\n"
